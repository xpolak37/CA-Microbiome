...
ALPHA DIVERSITY Mann Whitney showed no significant difference in alpha
diversity.
...
ORDINATION PERMANOVA revealed a significant difference between groups.
...
pheatmap(df, cluster_rows = TRUE, cluster_cols = TRUE)
